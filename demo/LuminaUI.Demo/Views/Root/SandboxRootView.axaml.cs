...
public partial class SandboxRootView : UserControl
{
    ...
    private Control CreatePage(string navigationName)
    {
        return navigationName switch
        {
            ...
            "NavVirtualizingWrapView" => new ItemsControlShowcasePage(),
    ...
    private static ShowcaseSourceInfo? GetSourceInfo(string navigationName)
    {
        return navigationName switch
        {
            ...
            "NavItemsControl" => Source("Components/ItemsControlShowcasePage", "ItemsControlShowcaseViewModel"),
            "NavVirtualizingWrapView" => Source("Components/ItemsControlShowcasePage", "ItemsControlShowcaseViewModel"),
