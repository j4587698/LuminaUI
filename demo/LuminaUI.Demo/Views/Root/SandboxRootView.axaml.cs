...
public partial class SandboxRootView : UserControl
{
    ...
    private Control CreatePage(string navigationName)
    {
        return navigationName switch
        {
            ...
            "NavFloatingWindow" => new FloatingWindowShowcasePage(),
            ...
            "NavOverlayScope" => new OverlayScopeShowcasePage(),
    ...
    private static ShowcaseSourceInfo? GetSourceInfo(string navigationName)
    {
        return navigationName switch
        {
            ...
            "NavFloatingWindow" => Source("Components/FloatingWindowShowcasePage", StaticShowcaseViewModel),
            ...
            "NavOverlayScope" => Source("Patterns/OverlayScopeShowcasePage", "OverlayScopeShowcaseViewModel"),
