...
var adminUser = builder.Configuration.GetValue<string>("Admin:Username") ?? "admin";
var adminPass = builder.Configuration.GetValue<string>("Admin:Password") ?? DefaultAdminPassword;
...
public sealed class ReindexService
{
    ...
    private const string RemoteUrl = "https://github.com/j4587698/LuminaUI.git";
    ...
    public async Task RunAsync(string? branchOrTag)
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Cloning {Ref} from {Remote}", branchOrTag ?? "default branch", RemoteUrl);
