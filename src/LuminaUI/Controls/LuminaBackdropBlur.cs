...
public sealed class LuminaBackdropBlur : Control
{
	...
	{
		BlurRadiusProperty = AvaloniaProperty.Register<LuminaBackdropBlur, double>("BlurRadius", 28.0);
		CornerRadiusProperty = AvaloniaProperty.Register<LuminaBackdropBlur, CornerRadius>("CornerRadius");
