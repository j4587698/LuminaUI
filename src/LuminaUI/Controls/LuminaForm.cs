...
public class LuminaForm : ItemsControl
{
    ...
    public static readonly StyledProperty<LuminaFormLabelPosition> LabelPositionProperty = AvaloniaProperty.Register<LuminaForm, LuminaFormLabelPosition>(nameof(LabelPosition), LuminaFormLabelPosition.Top);

    public static readonly StyledProperty<GridLength> LabelWidthProperty = AvaloniaProperty.Register<LuminaForm, GridLength>(nameof(LabelWidth), GridLength.Auto);

    public static readonly StyledProperty<double> ItemSpacingProperty = AvaloniaProperty.Register<LuminaForm, double>(nameof(ItemSpacing), 14.0);
    ...
    {
        recycleKey = null;
        return item is not LuminaFormItem && item is not LuminaFormGroup;
    }
    ...
    protected override void PrepareContainerForItemOverride(Control container, object? item, int index)
    {
        ...
        if (container is not LuminaFormItem formItem)
        {
