...
public class LuminaPlatformMenu : Menu
{
	...
	public static readonly StyledProperty<NativeMenu?> NativeMenuProperty = AvaloniaProperty.Register<LuminaPlatformMenu, NativeMenu?>("NativeMenu");

	public static readonly StyledProperty<LuminaNativeMenuMode> NativeMenuModeProperty = AvaloniaProperty.Register<LuminaPlatformMenu, LuminaNativeMenuMode>("NativeMenuMode", LuminaNativeMenuMode.MacOnly);

	public static readonly StyledProperty<bool> HideVisualMenuWhenNativeProperty = AvaloniaProperty.Register<LuminaPlatformMenu, bool>("HideVisualMenuWhenNative", defaultValue: true);

	public static readonly DirectProperty<LuminaPlatformMenu, bool> IsNativeMenuExportedProperty = AvaloniaProperty.RegisterDirect<LuminaPlatformMenu, bool>("IsNativeMenuExported", (LuminaPlatformMenu menu) => menu.IsNativeMenuExported, null, unsetValue: false);

	public NativeMenu? NativeMenu
	{
		get
		{
			return GetValue(NativeMenuProperty);
		}
		set
		{
			SetValue(NativeMenuProperty, value);
		}
	}
	...
	public LuminaNativeMenuMode NativeMenuMode
	{
		get
		{
			return GetValue(NativeMenuModeProperty);
		}
		set
		{
			SetValue(NativeMenuModeProperty, value);
		}
	}
	...
	public bool HideVisualMenuWhenNative
	{
		get
		{
			return GetValue(HideVisualMenuWhenNativeProperty);
		}
		set
		{
			SetValue(HideVisualMenuWhenNativeProperty, value);
		}
	}
	...
	private void RefreshNativeMenuExportState(bool shouldAttemptNative)
	{
		...
		base.IsVisible = !HideVisualMenuWhenNative || !isExported;
	}
}
