...
public class LuminaVirtualizingWrapPanel : VirtualizingPanel
{
    ...
    public static readonly StyledProperty<double> MinItemWidthProperty = AvaloniaProperty.Register<LuminaVirtualizingWrapPanel, double>(nameof(MinItemWidth), 220.0);

    public static readonly StyledProperty<double> MaxItemWidthProperty = AvaloniaProperty.Register<LuminaVirtualizingWrapPanel, double>(nameof(MaxItemWidth), double.PositiveInfinity);

    public static readonly StyledProperty<double> ItemWidthProperty = AvaloniaProperty.Register<LuminaVirtualizingWrapPanel, double>(nameof(ItemWidth), double.NaN);

    public static readonly StyledProperty<double> EstimatedItemHeightProperty = AvaloniaProperty.Register<LuminaVirtualizingWrapPanel, double>(nameof(EstimatedItemHeight), 160.0);

    public static readonly StyledProperty<double> HorizontalSpacingProperty = AvaloniaProperty.Register<LuminaVirtualizingWrapPanel, double>(nameof(HorizontalSpacing), 12.0);

    public static readonly StyledProperty<double> VerticalSpacingProperty = AvaloniaProperty.Register<LuminaVirtualizingWrapPanel, double>(nameof(VerticalSpacing), 12.0);

    public static readonly StyledProperty<int> MaxColumnsProperty = AvaloniaProperty.Register<LuminaVirtualizingWrapPanel, int>(nameof(MaxColumns), int.MaxValue);

    public static readonly StyledProperty<double> CacheLengthProperty = AvaloniaProperty.Register<LuminaVirtualizingWrapPanel, double>(nameof(CacheLength), 0.75);

    public static readonly StyledProperty<LuminaVirtualizingWrapLayoutMode> LayoutModeProperty = AvaloniaProperty.Register<LuminaVirtualizingWrapPanel, LuminaVirtualizingWrapLayoutMode>(nameof(LayoutMode), LuminaVirtualizingWrapLayoutMode.Wrap);
