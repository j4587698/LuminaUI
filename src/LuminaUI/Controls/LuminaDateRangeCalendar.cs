...
public class LuminaDateRangeCalendar : TemplatedControl
{
	...
	public static readonly StyledProperty<DateTime> DisplayMonthProperty = AvaloniaProperty.Register<LuminaDateRangeCalendar, DateTime>("DisplayMonth", StartOfMonth(DateTime.Today));

	public static readonly StyledProperty<DateTime?> DisplayDateStartProperty = AvaloniaProperty.Register<LuminaDateRangeCalendar, DateTime?>("DisplayDateStart");

	public static readonly StyledProperty<DateTime?> DisplayDateEndProperty = AvaloniaProperty.Register<LuminaDateRangeCalendar, DateTime?>("DisplayDateEnd");

	public static readonly StyledProperty<DateTime?> RangeStartProperty = AvaloniaProperty.Register<LuminaDateRangeCalendar, DateTime?>("RangeStart");

	public static readonly StyledProperty<DateTime?> RangeEndProperty = AvaloniaProperty.Register<LuminaDateRangeCalendar, DateTime?>("RangeEnd");

	public static readonly StyledProperty<DateTime?> PreviewDateProperty = AvaloniaProperty.Register<LuminaDateRangeCalendar, DateTime?>("PreviewDate");

	public static readonly StyledProperty<bool> IsPreviewingRangeProperty = AvaloniaProperty.Register<LuminaDateRangeCalendar, bool>("IsPreviewingRange", defaultValue: false);

	public static readonly StyledProperty<bool> ShowPreviousButtonProperty = AvaloniaProperty.Register<LuminaDateRangeCalendar, bool>("ShowPreviousButton", defaultValue: true);

	public static readonly StyledProperty<bool> ShowNextButtonProperty = AvaloniaProperty.Register<LuminaDateRangeCalendar, bool>("ShowNextButton", defaultValue: true);

	public static readonly DirectProperty<LuminaDateRangeCalendar, string> TitleTextProperty = AvaloniaProperty.RegisterDirect<LuminaDateRangeCalendar, string>("TitleText", (LuminaDateRangeCalendar calendar) => calendar.TitleText);
	...
	public bool IsPreviewingRange
	{
		get
		{
			return GetValue(IsPreviewingRangeProperty);
		}
		set
		{
			SetValue(IsPreviewingRangeProperty, value);
		}
	}
	...
	public bool ShowPreviousButton
	{
		get
		{
			return GetValue(ShowPreviousButtonProperty);
		}
		set
		{
			SetValue(ShowPreviousButtonProperty, value);
		}
	}
	...
	public bool ShowNextButton
	{
		get
		{
			return GetValue(ShowNextButtonProperty);
		}
		set
		{
			SetValue(ShowNextButtonProperty, value);
		}
	}
	...
	protected override void OnPointerExited(PointerEventArgs e)
	{
		...
		if (point.X < 0.0 || point.Y < 0.0 || point.X > base.Bounds.Width || point.Y > base.Bounds.Height)
		{
			this.DatePreviewed?.Invoke(this, new LuminaDateRangeCalendarDateEventArgs(null));
		}
	}
	...
	{
		if (this.DisplayMonthOffsetRequested != null)
		{
			this.DisplayMonthOffsetRequested(this, new LuminaDateRangeCalendarMoveEventArgs(offset));
		}
		else
		{
	...
	{
		this.DatePreviewed?.Invoke(this, e);
	}
