...
{
	private static readonly TimeSpan ExpansionDuration = TimeSpan.FromMilliseconds(150L);
	...
	public static readonly StyledProperty<object?> HeaderProperty = AvaloniaProperty.Register<LuminaNavigationItem, object?>("Header");

	public static readonly StyledProperty<object?> IconProperty = AvaloniaProperty.Register<LuminaNavigationItem, object?>("Icon");

	public static readonly StyledProperty<string?> NavigationKeyProperty = AvaloniaProperty.Register<LuminaNavigationItem, string?>("NavigationKey");

	public static readonly StyledProperty<bool> IsSelectedProperty = AvaloniaProperty.Register<LuminaNavigationItem, bool>("IsSelected", defaultValue: false, inherits: false, BindingMode.TwoWay);

	public static readonly StyledProperty<bool> IsExpandedProperty = AvaloniaProperty.Register<LuminaNavigationItem, bool>("IsExpanded", defaultValue: false, inherits: false, BindingMode.TwoWay);

	public static readonly StyledProperty<ICommand?> CommandProperty = AvaloniaProperty.Register<LuminaNavigationItem, ICommand?>("Command");

	public static readonly StyledProperty<object?> CommandParameterProperty = AvaloniaProperty.Register<LuminaNavigationItem, object?>("CommandParameter");

	public static readonly RoutedEvent<RoutedEventArgs> InvokedEvent = RoutedEvent.Register<LuminaNavigationItem, RoutedEventArgs>("Invoked", RoutingStrategies.Bubble);
	...
	protected override void OnApplyTemplate(TemplateAppliedEventArgs e)
	{
		...
		base.PseudoClasses.Set(":headerpointerover", value: false);
		UpdatePseudoClasses();
	...
	{
		base.PseudoClasses.Set(":headerpointerover", value: true);
	}
	...
	{
		return base.ItemsSource != null || base.Items.Count > 0;
	}
	...
	private void UpdatePseudoClasses()
	{
		...
		base.PseudoClasses.Set(":hasitems", HasNavigationChildren());
	}
	...
	private double MeasureItemsHeight()
	{
		...
		double width = _itemsContainer?.Bounds.Width ?? base.Bounds.Width;
		if (width <= 0.0)
		{
			width = ((base.Bounds.Width > 0.0) ? base.Bounds.Width : 220.0);
		}
