...
public class LuminaCascaderNode : AvaloniaObject
{
    public static readonly StyledProperty<bool> IsActiveProperty =
        AvaloniaProperty.Register<LuminaCascaderNode, bool>(nameof(IsActive), defaultValue: false);

    public static readonly StyledProperty<bool> IsLoadingProperty =
        AvaloniaProperty.Register<LuminaCascaderNode, bool>(nameof(IsLoading), defaultValue: false);

    public string Label { get; set; } = string.Empty;

    public object? Value { get; set; }

    public AvaloniaList<LuminaCascaderNode> Children { get; set; } = [];
