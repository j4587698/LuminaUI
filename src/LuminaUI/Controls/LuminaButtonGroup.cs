...
{
    public static readonly StyledProperty<int> SelectedIndexProperty = AvaloniaProperty.Register<LuminaButtonGroup, int>(nameof(SelectedIndex), 0, inherits: false, BindingMode.TwoWay);

    public static readonly StyledProperty<bool> IsSelectionRequiredProperty = AvaloniaProperty.Register<LuminaButtonGroup, bool>(nameof(IsSelectionRequired), defaultValue: true);

    public static readonly StyledProperty<ICommand?> SelectionChangedCommandProperty = AvaloniaProperty.Register<LuminaButtonGroup, ICommand?>(nameof(SelectionChangedCommand));
    ...
    {
        get => GetValue(IsSelectionRequiredProperty);
    ...
    private void SyncSelection()
    {
        ...
        {
            if (Children[index] is Button button)
            {
                SetClass(button, "First", index == 0);
                SetClass(button, "Last", index == Children.Count - 1);
