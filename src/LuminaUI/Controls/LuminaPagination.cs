...
public class LuminaPagination : TemplatedControl
{
	...
	public static readonly StyledProperty<int> CurrentPageProperty = AvaloniaProperty.Register<LuminaPagination, int>("CurrentPage", 1, inherits: false, BindingMode.TwoWay);

	public static readonly StyledProperty<int> PageCountProperty = AvaloniaProperty.Register<LuminaPagination, int>("PageCount", 1);

	public static readonly StyledProperty<int> TotalCountProperty = AvaloniaProperty.Register<LuminaPagination, int>("TotalCount", 0);

	public static readonly StyledProperty<int> PageSizeProperty = AvaloniaProperty.Register<LuminaPagination, int>("PageSize", 10, inherits: false, BindingMode.TwoWay);
	...
	public static readonly StyledProperty<int> MaxVisiblePagesProperty = AvaloniaProperty.Register<LuminaPagination, int>("MaxVisiblePages", 7);

	public static readonly StyledProperty<bool> ShowEdgeButtonsProperty = AvaloniaProperty.Register<LuminaPagination, bool>("ShowEdgeButtons", defaultValue: true);

	public static readonly StyledProperty<bool> ShowPreviousNextButtonsProperty = AvaloniaProperty.Register<LuminaPagination, bool>("ShowPreviousNextButtons", defaultValue: true);

	public static readonly StyledProperty<bool> ShowFastJumpProperty = AvaloniaProperty.Register<LuminaPagination, bool>("ShowFastJump", defaultValue: true);

	public static readonly StyledProperty<bool> ShowPageInfoProperty = AvaloniaProperty.Register<LuminaPagination, bool>("ShowPageInfo", defaultValue: true);

	public static readonly StyledProperty<bool> ShowTotalProperty = AvaloniaProperty.Register<LuminaPagination, bool>("ShowTotal", defaultValue: false);

	public static readonly StyledProperty<bool> ShowQuickJumpProperty = AvaloniaProperty.Register<LuminaPagination, bool>("ShowQuickJump", defaultValue: false);

	public static readonly StyledProperty<bool> ShowPageSizeSelectorProperty = AvaloniaProperty.Register<LuminaPagination, bool>("ShowPageSizeSelector", defaultValue: false);

	public static readonly StyledProperty<bool> DisplayCurrentPageInQuickJumperProperty = AvaloniaProperty.Register<LuminaPagination, bool>("DisplayCurrentPageInQuickJumper", defaultValue: false);

	public static readonly StyledProperty<string> QuickJumpTextProperty = AvaloniaProperty.Register<LuminaPagination, string>("QuickJumpText", "Go to");

	public static readonly StyledProperty<string> PageTextProperty = AvaloniaProperty.Register<LuminaPagination, string>("PageText", "page");

	public static readonly StyledProperty<string> PageInfoFormatProperty = AvaloniaProperty.Register<LuminaPagination, string>("PageInfoFormat", "{0} / {1}");

	public static readonly StyledProperty<string> TotalTextFormatProperty = AvaloniaProperty.Register<LuminaPagination, string>("TotalTextFormat", "{0} items");

	public static readonly StyledProperty<ICommand?> PageChangedCommandProperty = AvaloniaProperty.Register<LuminaPagination, ICommand?>("PageChangedCommand");

	public static readonly DirectProperty<LuminaPagination, string> PageInfoTextProperty = AvaloniaProperty.RegisterDirect<LuminaPagination, string>("PageInfoText", (LuminaPagination pagination) => pagination.PageInfoText);

	public static readonly DirectProperty<LuminaPagination, string> TotalInfoTextProperty = AvaloniaProperty.RegisterDirect<LuminaPagination, string>("TotalInfoText", (LuminaPagination pagination) => pagination.TotalInfoText);
	...
	public int PageCount
	{
		get
		{
			return GetValue(PageCountProperty);
		}
		set
		{
	...
	public int TotalCount
	{
		get
		{
			return GetValue(TotalCountProperty);
		}
		set
		{
	...
	public int PageSize
	{
		get
		{
			return GetValue(PageSizeProperty);
		}
		set
		{
	...
	public AvaloniaList<int>? PageSizeOptions
	{
		get
		{
			return GetValue(PageSizeOptionsProperty);
		}
		set
		{
			SetValue(PageSizeOptionsProperty, value);
		}
	}
	...
	public int MaxVisiblePages
	{
		get
		{
			return GetValue(MaxVisiblePagesProperty);
		}
		set
		{
			SetValue(MaxVisiblePagesProperty, value);
		}
	}
	...
	public bool ShowEdgeButtons
	{
		get
		{
			return GetValue(ShowEdgeButtonsProperty);
		}
		set
		{
			SetValue(ShowEdgeButtonsProperty, value);
		}
	}
	...
	public bool ShowPreviousNextButtons
	{
		get
		{
			return GetValue(ShowPreviousNextButtonsProperty);
		}
		set
		{
			SetValue(ShowPreviousNextButtonsProperty, value);
		}
	}
	...
	public bool ShowFastJump
	{
		get
		{
			return GetValue(ShowFastJumpProperty);
		}
		set
		{
			SetValue(ShowFastJumpProperty, value);
		}
	}
	...
	public bool ShowPageInfo
	{
		get
		{
			return GetValue(ShowPageInfoProperty);
		}
		set
		{
			SetValue(ShowPageInfoProperty, value);
		}
	}
	...
	public bool ShowTotal
	{
		get
		{
			return GetValue(ShowTotalProperty);
		}
		set
		{
			SetValue(ShowTotalProperty, value);
		}
	}
	...
	public bool ShowQuickJump
	{
		get
		{
			return GetValue(ShowQuickJumpProperty);
		}
		set
		{
			SetValue(ShowQuickJumpProperty, value);
		}
	}
	...
	public bool ShowPageSizeSelector
	{
		get
		{
			return GetValue(ShowPageSizeSelectorProperty);
		}
		set
		{
			SetValue(ShowPageSizeSelectorProperty, value);
		}
	}
	...
	public bool DisplayCurrentPageInQuickJumper
	{
		get
		{
			return GetValue(DisplayCurrentPageInQuickJumperProperty);
		}
		set
		{
			SetValue(DisplayCurrentPageInQuickJumperProperty, value);
		}
	}
	...
	public string QuickJumpText
	{
		get
		{
			return GetValue(QuickJumpTextProperty);
		}
		set
		{
			SetValue(QuickJumpTextProperty, value);
		}
	}
	...
	public string PageText
	{
		get
		{
			return GetValue(PageTextProperty);
		}
		set
		{
	...
	public string PageInfoFormat
	{
		get
		{
			return GetValue(PageInfoFormatProperty);
		}
		set
		{
			SetValue(PageInfoFormatProperty, value);
		}
	}
	...
	public string TotalTextFormat
	{
		get
		{
			return GetValue(TotalTextFormatProperty);
		}
		set
		{
			SetValue(TotalTextFormatProperty, value);
		}
	}
	...
	public ICommand? PageChangedCommand
	{
		get
		{
			return GetValue(PageChangedCommandProperty);
		}
		set
		{
			SetValue(PageChangedCommandProperty, value);
		}
	}
