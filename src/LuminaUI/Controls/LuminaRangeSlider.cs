...
public class LuminaRangeSlider : TemplatedControl
{
    ...
    {
        get => GetValue(IsSnapToStepProperty);
    ...
    {
        MinimumProperty = AvaloniaProperty.Register<LuminaRangeSlider, double>(nameof(Minimum), 0.0);
        MaximumProperty = AvaloniaProperty.Register<LuminaRangeSlider, double>(nameof(Maximum), 100.0);
        LowerValueProperty = AvaloniaProperty.Register<LuminaRangeSlider, double>(nameof(LowerValue), 0.0, inherits: false, BindingMode.TwoWay);
        UpperValueProperty = AvaloniaProperty.Register<LuminaRangeSlider, double>(nameof(UpperValue), 100.0, inherits: false, BindingMode.TwoWay);
        StepProperty = AvaloniaProperty.Register<LuminaRangeSlider, double>(nameof(Step), 1.0);
        IsSnapToStepProperty = AvaloniaProperty.Register<LuminaRangeSlider, bool>(nameof(IsSnapToStep), defaultValue: false);
        TrackHeightProperty = AvaloniaProperty.Register<LuminaRangeSlider, double>(nameof(TrackHeight), 8.0);
        ThumbSizeProperty = AvaloniaProperty.Register<LuminaRangeSlider, double>(nameof(ThumbSize), 18.0);
        TrackBrushProperty = AvaloniaProperty.Register<LuminaRangeSlider, IBrush?>(nameof(TrackBrush));
        SelectionBrushProperty = AvaloniaProperty.Register<LuminaRangeSlider, IBrush?>(nameof(SelectionBrush));
        ThumbBrushProperty = AvaloniaProperty.Register<LuminaRangeSlider, IBrush?>(nameof(ThumbBrush));
        ThumbBorderBrushProperty = AvaloniaProperty.Register<LuminaRangeSlider, IBrush?>(nameof(ThumbBorderBrush));
        RangeChangedCommandProperty = AvaloniaProperty.Register<LuminaRangeSlider, ICommand?>(nameof(RangeChangedCommand));
    ...
    private void DrawThumb(DrawingContext context, Rect trackRect, double ratio, bool isActive)
    {
        ...
        if (!(thumbSize <= 0.0))
        {
            ...
            bool active = _isPointerOver || _isDragging || (isActive && IsKeyboardFocusWithin);
