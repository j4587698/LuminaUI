...
public sealed class LuminaCommand : AvaloniaObject
{
	...
	static LuminaCommand()
	{
		...
		ClickCommandProperty.Changed.AddClassHandler(delegate(AvaloniaObject target, AvaloniaPropertyChangedEventArgs _)
		{
			UpdateClickSubscription(target);
		});
		TextChangedCommandProperty.Changed.AddClassHandler(delegate(AvaloniaObject target, AvaloniaPropertyChangedEventArgs _)
		{
			UpdateTextChangedSubscription(target);
		});
		SelectionChangedCommandProperty.Changed.AddClassHandler(delegate(AvaloniaObject target, AvaloniaPropertyChangedEventArgs _)
		{
			UpdateSelectionChangedSubscription(target);
		});
		TappedCommandProperty.Changed.AddClassHandler(delegate(AvaloniaObject target, AvaloniaPropertyChangedEventArgs _)
		{
			UpdateTappedSubscription(target);
		});
		LoadedCommandProperty.Changed.AddClassHandler(delegate(AvaloniaObject target, AvaloniaPropertyChangedEventArgs _)
		{
